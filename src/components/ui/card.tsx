  ...
  "overflow-hidden rounded-2xl border backdrop-blur-sm transition-shadow duration-300",
  {
    variants: {
      variant: {
        ...
        dark:
          "border-[color-mix(in_srgb,var(--color-primary)_20%,var(--color-border))] bg-[linear-gradient(165deg,#161b22,#0d1117)] text-white shadow-[0_20px_50px_-36px_rgba(0,0,0,0.75)]"
      }
    },
    defaultVariants: {
      variant: "default"
